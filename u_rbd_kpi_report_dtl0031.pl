/opt/etl/prd/etl/APP/RBD/Z_RBD_KPI_REPORT_DTL_UAT/bin> cat u_rbd_kpi_report_dtl0031.pl
######################################################
...
my $TARGET_TABLE = "RBD_KPI_REPORT_SERV_REV_DTL";
my $SOURCE_DB = "$etlvar::MIGDB";
my $SOURCE_TABLE = "U_RBD_KPI_REPORT_SERV_REV_T001";
