...
java -cp "`hbase classpath`" org.apache.hadoop.hbase.mapreduce.ImportTsv -Dmapreduce.tasktracker.map.tasks.maximum=30 '-Dimporttsv.separator=|'  -Dcreate.table=no -Dimporttsv.skip.bad.lines=false -Dimporttsv.columns="HBASE_ROW_KEY,cf:start_datetime,cf:src,cf:json_value" /HDS_VOL_HBASE/TEST/FW_CDR_05 maprfs:///HDS_VOL_HIVE/TEST/FWCDR/start_date=20200512/fwcdr_ldr_20200512_20200512230951_p3_003.gz
