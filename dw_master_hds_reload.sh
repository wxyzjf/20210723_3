[mapr@bigdatamr09 script]$ cat dw_master_hds_reload.sh
#! /bin/ksh
#
...
[mapr@bigdatamr09 script]$ ls -l
total 148
-rw-r--r-- 1 mapr mapr     0 Aug 14  2019 a.out
-rwxrwxr-x 1 mapr mapr  1484 Sep 16 09:58 dw_add_partitions_fwpq.sh
-rwxr-xr-x 1 mapr mapr  2963 Aug 13  2019 dw_load_ctr_cdr.sh
-rwxr-xr-x 1 mapr mapr  1803 Aug 24 13:43 dw_load_fwcdr_maprdb.sh
-rwxr-xr-x 1 mapr mapr 27098 Sep  1 17:13 dw_master_hds_reload_el.sh
-rwxr-xr-x 1 mapr mapr 27018 Aug 13  2019 dw_master_hds_reload.sh
-rwxr-xr-x 1 mapr mapr   126 Aug 13  2019 listmodule.pl
-rw------- 1 mapr mapr 77639 May 13 19:34 nohup.out
