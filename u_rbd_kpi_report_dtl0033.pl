/opt/etl/prd/etl/APP/RBD/Z_RBD_KPI_REPORT_DTL_UAT/bin> cat u_rbd_kpi_report_dtl0033.pl
######################################################
...
my $ETLVAR = "/opt/etl/prd/etl/APP/RBD/X_U_RBD_KPI_REPORT_DTL_UAT/bin/master_dev.pl";
...
my $TARGET_TABLE = "RBD_KPI_REPORT_SIM_DTL";
my $SOURCE_DB = "$etlvar::MIGDB";
my $SOURCE_TABLE = "U_RBD_KPI_REPORT_SIM_T001";
